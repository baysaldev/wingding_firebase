...
import 'package:wingding_firebase/common_widget/platform_duyarli_alert_dialog.dart.dart';
import 'package:wingding_firebase/common_widget/social_log_in_button.dart';
import 'package:wingding_firebase/model/user_model.dart';
import 'package:wingding_firebase/ui/hata_exception.dart';
                ...
                child: Form(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        FlatButton(
                          onPressed: () => _degistir(),
                          child: Text("kayıt ol yada değiş"),
                        ),
                      ],
                    )),
              ),
